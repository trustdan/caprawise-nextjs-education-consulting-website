...
export default function QA({ question, answer }: QAProps) {
  ...
  return (
    <div
      className="border-b dark:border-gray-800 rounded-md p-5 mb-2 mx-4 bg-LIGHT_SECONDARY_BG_COLOR dark:bg-DARK_SECONDARY_BG_COLOR dark:text-white transition-colors ease-linear duration-300"
      ref={QARef}
    >
      <div
